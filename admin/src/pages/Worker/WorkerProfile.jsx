...
const WorkerProfile = () => {
    const { wToken, profileData, setProfileData, getProfileData } = useContext(WorkerContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/worker/update-profile', updateData, { headers: { wToken } })
            ...
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <div className='flex items-center gap-2 mt-1 text-gray-600'>
                        <p>{profileData.degree} - {profileData.service}</p>
